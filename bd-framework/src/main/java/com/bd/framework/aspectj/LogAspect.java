package com.bd.framework.aspectj;

import com.bd.common.annotation.Log;
import com.bd.common.enums.BusinessStatus;
import com.bd.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.bd.common.annotation.Log)")
